...
public class photoRender implements GLSurfaceView.Renderer{
	...
	// Constant for requesting left page rect.
		...
		private Vector<photoMesh> mCurlMeshes;
		private RectF mMargins = new RectF();
		private photoRender.Observer mObserver;
		// Page rectangles.
		 ...
		 * Basic constructor.
		 */
		public photoRender(photoRender.Observer observer) {
			mObserver = observer;
			mCurlMeshes = new Vector<photoMesh>();
		 ...
		 */
		public synchronized void addCurlMesh(photoMesh mesh) {
			removeCurlMesh(mesh);
		 ...
		 */
		public synchronized void removeCurlMesh(photoMesh mesh) {
